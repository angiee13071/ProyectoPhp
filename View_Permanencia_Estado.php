...
<body>
    ...
    <div class="card">
        ...
        <!-- <div class="textSmall" style="font-size:1rem;">
            * Retención: Capacidad de mantener a los estudiantes y evitar que abandonen sus
            estudios, *Graduación: Cuántos estudiantes terminan sus estudios con éxito.
        </div> -->
...
ORDER BY
    ...
    function exportChart() {
        ...
        html2canvas(chartContainer).then(function(canvas) {
            ...
            downloadLink.download = 'Permanencia_Estado.png'; // Nombre del archivo a descargar
