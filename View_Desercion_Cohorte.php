...
<head>
    ...
    <title>Deserción estudiantil por cohorte</title>
...
<body>
    ...
    <div class="card">
        <div class="title">
            <h1>Deserción estudiantil por cohorte</h1>
        </div>
...
";
    ...
    function exportChart() {
        ...
        html2canvas(chartContainer).then(function(canvas) {
            ...
            downloadLink.download = 'Deserción_cohorte.png'; // Nombre del archivo a descargar
